...
To import classes/methods of `arxiv2025_abcd_link` from inside the package itself you can use relative imports: 
...
```py
from arxiv2025_abcd_link import BaseClass # Notice how I omit the file name
from arxiv2025_abcd_link.subpackage import SubPackageClass # Here it's necessary because it's a subpackage
...
This is how you can use `arxiv2025_abcd_link` from command line:

```bash
$ python -m arxiv2025_abcd_link
```
